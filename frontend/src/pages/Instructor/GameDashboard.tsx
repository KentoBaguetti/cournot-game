...
export default function GameDashboard() {
  ...
  const [roomsAndPlayers, setRoomsAndPlayers] = useState<Record<string, string[]>>({});
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-200">
                  Welcome, <span className="font-semibold text-white">{hostName}</span>
                </p>
              </div>
            </div>
            <Button
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          <div className="text-center">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-6 mb-4">
              ...
              <p className="text-orange-700 text-sm">Share this code with students to join</p>
            </div>
            <Button
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          {/* Breakout Rooms */}
          <Card>
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Breakout Rooms</h3>
                ...
                Object.entries(roomsAndPlayers).map(([roomId, players]) => (
                  <div key={roomId} className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="text-sm text-gray-600">
                      Players: {players.length > 0 ? players.join(", ") : "Empty"}
                    </div>
                  </div>
                ))
              ) : (
        ...
        <Card className="mt-8">
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Game Controls</h3>
            ...
            {!gameStarted ? (
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                <div className="text-green-800 font-semibold mb-2">Game Started!</div>
